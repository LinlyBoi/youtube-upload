...
def get_youtube_handler(options):
    ...
    client_secrets = options.client_secrets or os.path.join(
        home, ".client_secrets.json"
    )
...
def main(arguments):
    ...
    parser.add_option(
        "", "--embeddable", dest="embeddable", default=True, help="Video is embeddable"
    )
